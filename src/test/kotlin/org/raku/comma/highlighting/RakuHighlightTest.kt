...
class RakuHighlightTest : CommaFixtureTestCase() {
    ...
    fun testDuplicatedVariables() {
        myFixture.configureByText(RakuScriptFileType.INSTANCE, "my \$foo; say \$foo; my <warning descr=\"Re-declaration of \$foo from aaa.raku:1\"><weak_warning descr=\"Unused variable\">\$foo</weak_warning></warning>; say \$foo;")
        myFixture.checkHighlighting()
        myFixture.configureByText(RakuScriptFileType.INSTANCE, "\nmy \$bar;\nsay \$bar;\n{ my \$bar; say \$bar; };\nmy <warning descr=\"Re-declaration of \$bar from aaa.raku:2\"><weak_warning descr=\"Unused variable\">\$bar</weak_warning></warning>;\nsay \$bar;")
        myFixture.checkHighlighting()
        myFixture.configureByText(RakuScriptFileType.INSTANCE, "sub blah(\$x) { my <warning descr=\"Re-declaration of \$x from aaa.raku:1\"><weak_warning descr=\"Unused variable\">\$x</weak_warning></warning> = 42; say \$x; }; blah(3);")
        myFixture.checkHighlighting()
        myFixture.configureByText(RakuScriptFileType.INSTANCE, "sub x() {}; my <warning descr=\"Re-declaration of &x from aaa.raku:1\"><weak_warning descr=\"Unused variable\">&x</weak_warning></warning> = -> {}")
        myFixture.checkHighlighting()
    ...
    fun testDuplicateAttributes() {
        myFixture.configureByText(RakuScriptFileType.INSTANCE, "class C { has <weak_warning descr=\"Unused attribute\">\$!a</weak_warning>; has <error descr=\"Re-declaration of \$!a from aaa.raku:1\">\$.a</error>; }")
        myFixture.checkHighlighting()
    }
